...
const Navbar = () => {
    ...
    return (
        <nav className="flex h-[10vh] min-h-[80px] px-12 space-x-3 w-4/5 dark:bg-dark-background fixed bg-white opacity-100 z-10 top-0">
            {/* <!-- search icon --> */}
            <div className="flex my-auto rounded-xl bg-gray-50 w-2/3 dark:bg-dark-bg-2 dark:text-dark-on-background/75">
                <MagnifyingGlassIcon className="w-6 mx-3 my-auto bg-transparent stroke-gray-400 dark:stroke-gray-500" />
                <input
                    className="my-auto w-full h-10 rounded-xl bg-inherit focus:outline-none dark:placeholder:text-dark-on-background/30 peer dark:caret-dark-bg-5"
                    type="text"
                    placeholder="Search"
                />
            </div>
